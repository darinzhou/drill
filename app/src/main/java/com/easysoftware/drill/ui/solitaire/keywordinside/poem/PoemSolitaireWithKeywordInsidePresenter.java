...
import com.easysoftware.drill.ui.solitaire.keywordinside.SolitaireWithKeywordInsideBasePresenter;

import javax.inject.Inject;

public class PoemSolitaireWithKeywordInsidePresenter extends SolitaireWithKeywordInsideBasePresenter {
    ...
    @Inject
    public PoemSolitaireWithKeywordInsidePresenter(PoemDbHelper dbHelper) {
        super(dbHelper);
    }
