...
public class PoemSolitaireWithKeywordHeadAndTailPresenter extends SolitaireWithKeywordHeadAndTailBasePresenter {
    ...
    @Inject
    public PoemSolitaireWithKeywordHeadAndTailPresenter(PoemDbHelper dbHelper) {
        super(dbHelper);
    }
